...
var bb = {
  ...
  crawl : function (askey) {
    $.getJSON('https://www.whateverorigin.org/get?url=' + encodeURIComponent('https://answers.search.yahoo.com/search?fr=uh3_answers_vert_gs&type=2button&p=' + askey) + '&callback=?', function(data){
...
function getAnswer(link) {
  $.getJSON('https://www.whateverorigin.org/get?url=' + encodeURIComponent(link) + '&callback=?', function(data){
